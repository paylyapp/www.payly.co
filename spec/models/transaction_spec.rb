...
describe Transaction do
  describe 'using Pin payments' do
    before :each do
      @pin_user = FactoryGirl.create(:user, :email => "tim.j.gleeson+pin@gmail.com")
      @entity = Entity.find_by_user_token(@pin_user.user_token)
      @entity.update_attributes(:payment_method => 'pin_payments', :pin_api_key => ENV['PIN_PUBLISHABLE_KEY'], :pin_api_secret => ENV['PIN_SECRET_KEY'])
    end
    ...
    describe "charge $10.00" do
      it "default" do
        @pin_stack = FactoryGirl.create(:stack,
                                        ...
                                        :entity_token => @entity.entity_token,
  ...
  describe 'using Stripe' do
    before :each do
      @pin_user = FactoryGirl.create(:user, :email => "tim.j.gleeson+pin@gmail.com")
      @entity = Entity.find_by_user_token(@pin_user.user_token)
      @entity.update_attributes(:payment_method => 'stripe', :stripe_api_key => ENV['STRIPE_PUBLISHABLE_KEY'], :stripe_api_secret => ENV['STRIPE_SECRET_KEY'])
    end
    ...
    describe "charge $10.00" do
      it "default" do
        ...
        Stripe.api_key = @entity.stripe_api_secret
  ...
  describe 'using Braintree' do
    before :each do
      ...
      @entity = Entity.find_by_user_token(@pin_user.user_token)
      @entity.update_attributes(:payment_method => 'braintree',
