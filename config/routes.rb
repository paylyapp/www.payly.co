Haystack::Application.routes.draw do
  ...
  get     "pages/new"                         => "stacks#new_stack",                :as => 'dashboard_new_stack'
  get     "pages/:stack_token"                => "stacks#stack",                  :as => 'dashboard_stack'
  get     "pages/:stack_token/purchases"      => "stacks#stack_transactions",     :as => 'dashboard_stack_transactions'
  get     "pages/:stack_token/update/buyer/download" => "stacks#stack_updated_download",  :as => 'dashboard_stack_updated_download'

  get     "/purchases/:transaction_token" => "stacks#stack_transaction",      :as => 'dashboard_stack_transaction'

  post    "pages/s_new"                   => "stacks#create_stack",           :as => 'stack_create'
  put     "pages/:stack_token"            => "stacks#update_stack",           :as => 'stack_update'
  delete  "pages/:stack_token/destroy"    => "stacks#destroy_stack",          :as => 'stack_destroy'
