class Transaction < ActiveRecord::Base
  ...
  def self.new_by_stack(params, stack)
    ...
    if stack.entity.payment_provider_is_pin_payments?
      ...
      begin
        charge = Hay::Charges.create(stack.entity.pin_api_secret, payload)
    ...
    elsif stack.entity.payment_provider_is_stripe?
      Stripe.api_key = stack.entity.stripe_api_secret
      amount = (amount * 100).to_i
    ...
    elsif stack.entity.payment_provider_is_braintree?
      user_gateway = Braintree::Gateway.new(:merchant_id => stack.entity.braintree_merchant_key,
                                            :public_key  => stack.entity.braintree_api_key,
                                            :private_key => stack.entity.braintree_api_secret,
